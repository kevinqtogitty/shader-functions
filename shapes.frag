...
//-------------------------------------------Making a circle ring-------------------------------------------\\
    ...
    // 1. The LENGTH of the vector from the pixel to the center, add the same function with a slightly lrager randius
    // out center 
    vec2 distanceToTheMiddle = vec2(0.5)-st;
    float pixelDistanceFromTheMiddle = ((1.0 - step(.4 ,length(distanceToTheMiddle))) + (step(.41 ,length(distanceToTheMiddle)))); 
